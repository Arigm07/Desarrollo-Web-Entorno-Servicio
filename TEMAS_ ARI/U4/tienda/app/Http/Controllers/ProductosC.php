    ...
    function crearPedido(Request $request){
        ...
        foreach($carrito as $c){
            ...
            if($c->precioU!=$c->producto->precio){
                return back()->
                with('error','Error, el producto'.$c->producto->nombre.'ha cambiado el precio. Borra el producto de la cesta para poder crear el pedido');
            }
            //Comprobar si hay stock0
        }


        //Convertir cada línea del carrito en un pedido y vaciar el carrito
        //Tambien hay que modificar el stock
        //Vamos a hacer varios insert y deletes por lo que tenemos que hacer una transición
        try {
